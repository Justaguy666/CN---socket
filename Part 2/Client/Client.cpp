...
void downloadingFile(CSocket& client, FileInfo file)
{
    ...
    if (ofs.is_open())
    {
        ...
        while (totalCurrentBytes < sizeBytes)
        {
            ...
            float percentDownloading = totalCurrentBytes * 100.0 / sizeBytes;
...
int main() {
    ...
    if (hModule != nullptr) {
        if (!AfxWinInit(hModule, nullptr, ::GetCommandLine(), 0)) {
            ...
            {
                downloadingFile(clientSocket, filesFromClient[i]);
            }
